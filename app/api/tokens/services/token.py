...
from app.tokens.schemas import TokenDataDTO, RefreshTokenPairDTO, RevokeTokenPairDTO, RevokeAllTokensDTO, TokenPairDTO
    ...
    def _get_token_model(
        ...
        *,
        ...
        return TokenModel(
            ...
            ip=self._ip_header,
            location=self._location_header,
            os=self._os_header,
            device=self._device_header,
            source=self._source_header,
