...
from app.tokens.models import TokenModel
...
class RedisTokenAdapter:
    ...
    async def get_token(
        ...
        *,
        ...
        pattern = TokenModel.create_redis_record_key(sid=token_sid)
        token_model = None
        ...
        try:
            ...
            token_model = TokenModel.model_validate_json(
    ...
    async def create_token_pair(
        ...
        *,
        ...
        access_token_serialize_model = access_token.model_dump_json()
        refresh_token_serialize_model = refresh_token.model_dump_json()

        try:
            await self._redis_client.set(
                name=access_token.redis_record_key,
                value=access_token_serialize_model,
            )
            ...
            await self._redis_client.set(
                ...
                value=refresh_token_serialize_model,
            )
            await self._redis_client.expireat(
                name=refresh_token.redis_record_key,
    ...
    async def remove_token_pair(
        ...
        *,
        ...
        pattern = TokenModel.construct_redis_record_key(
            token_owner=token_owner, fingerprint=fingerprint
        )
        keys_to_remove = []
        ...
        try:
            ...
            if keys_to_remove:
                ...
                self._logger.warning(
                    "There are no records to remove token pair for pattern %s",
                    pattern,
                )
        except Exception as e:
            self._logger.error(
        ...
        *,
        ...
        try:
            ...
            if keys_to_remove:
                ...
                self._logger.warning(
                    "There are no records to remove all tokens for pattern %s",
                    pattern,
                )
        except Exception as e:
            self._logger.error(
